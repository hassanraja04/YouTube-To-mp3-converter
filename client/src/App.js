              ...
              {showModal && (
                <div className='modal'>
                  <div className='modal-content'>
                    ...
                    <p>
                      Due to the running costs of keeping the backend live, this YouTube-to-MP3 converter is only available to run on local devices. You can view and download the full code from <a href="https://github.com/hassanraja04/YouTube-To-Mp3-Converter-For-Local-Use.git" target="_blank" rel="noopener noreferrer">GitHub</a> and run it locally.
                    </p>
